  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
              ...
              <CardHeader>
                <div className="flex items-start justify-between mb-2">
                  ...
                  <Badge
                    ...
                    className={pillar.impact === 'High' ? 'bg-primary' : ''}
                  >
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl">Strategic Action Roadmap</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-4">
            {actionItems.map((item, i) => (
              <div
                key={i}
                className="flex gap-4 p-4 rounded-lg border hover:border-primary/50 transition-colors bg-card"
              >
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-bold">$425,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-medium">Projected ROI</span>
                  <span className="text-sm font-bold text-primary">285%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-medium">Payback Period</span>
                  <span className="text-sm font-bold">8-10 months</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-bold">1-3 months</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-medium">Core Initiatives</span>
                  <span className="text-sm font-bold">3-6 months</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm font-medium">Full Implementation</span>
                  <span className="text-sm font-bold">6-12 months</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {!isScheduled ? (
          <Card className="bg-gradient-to-r from-primary/20 via-primary/10 to-primary/5 border-primary/30">
            <CardHeader>
              <CardTitle className="text-2xl">Ready to Launch Your Strategy?</CardTitle>
              <CardDescription className="text-base">
                Schedule a strategic implementation session with our expert team to refine your
                plan and accelerate execution
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
              ...
              >
                ...
                Schedule Your Strategic Implementation Session
              </Button>
            </CardContent>
          </Card>
        ) : (
