...
export default function LandingPage() {
  ...
  return (
    <div className="dark-theme min-h-screen relative">
      ...
      {/* Main Content */}
      <div className={`transition-page ${!contentVisible ? 'blur-exit' : ''}`}>
        ...
        <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-4 sm:px-6 lg:px-4">
          <div className="max-w-5xl mx-auto text-center space-y-8 sm:space-y-10 lg:space-y-12">
            ...
            <div className="pt-4 sm:pt-2">
              <Button
                size="lg"
                onClick={handleSignUpClick}
                className="bg-primary hover:bg-primary/90 text-white font-semibold px-3 sm:px-6 lg:px-12 py-4 sm:py-6 lg:py-8 h-auto rounded-lg sm:rounded-xl shadow-2xl shadow-primary/20 transition-all hover:scale-105 w-full sm:w-auto max-w-xs sm:max-w-md lg:max-w-none"
              >
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 pt-6 sm:pt-8 lg:pt-12 max-w-4xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="frosted-glass rounded-lg sm:rounded-xl lg:rounded-2xl p-4 sm:p-4 lg:p-6 space-y-3 sm:space-y-3 lg:space-y-4 hover:bg-white/20 transition-all animate-slide-in-up"
            ...
            <div className="pt-8 sm:pt-10 lg:pt-12 border-t border-white/10 text-center space-y-1 sm:space-y-2">
          ...
          <div className="h-6 sm:h-6 lg:h-8"></div>
        </main>
      </div>
